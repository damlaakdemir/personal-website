...
function Header() {
    return (
        <header className="col-lg-4 col-md-4 col-sm-12 col-12 header">
                    ...
                    <Link href="">
                        <a>
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope-square"
                                 className="svg-inline--fa fa-envelope-square header__icon" role="img"
                    ...
                    <Link href="//github.com/damlaakdemir">
                        <a target="_blank">
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github-square"
                                 className="svg-inline--fa fa-github-square header__icon" role="img"
                                 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path fill="currentColor"
                    ...
                    <Link href="//www.linkedin.com/in/damla-akdemir-207743145/">
                        <a target="_blank">
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin"
                                 className="svg-inline--fa fa-linkedin header__icon" role="img"
                                 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path fill="currentColor"
            ...
            <div className="col-12 mb-3 header__footer d-none d-md-block">
                <span className="header__footer__text">© 2020 damlaakdemir.com</span>
            </div>
        </header>
    )
}
